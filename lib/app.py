...
def index():
    ...
    [
        ...
        spot_report,
        spot_info,
    ] = forecast.get_forecasts(spot_id)
    ...
    last_reading["timestamp"] = utils.str_to_local_timestamp(
        last_reading["timestamp"], spot_info["utcOffset"]
    )

    if last_training:
        last_training["timestamp"] = utils.str_to_local_timestamp(
            last_training["timestamp"], spot_info["utcOffset"]
        )
